  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xs animate-in fade-in duration-150">
      ...
      >
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-slate-200/90 bg-slate-50 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-2.5 pb-[max(env(safe-area-inset-bottom),0.75rem)]">
          <button
            onClick={onClose}
            disabled={isProcessing}
            className="w-full sm:w-auto px-4 py-2 text-xs font-medium text-slate-600 hover:text-slate-900 bg-white hover:bg-slate-100 border border-slate-200 rounded-xl transition-colors shadow-2xs text-center"
          >
            ปิดหน้าต่าง
          </button>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            ...
            <button
              ...
              disabled={isProcessing}
              className="w-full sm:w-auto justify-center px-4 py-2 text-xs font-bold text-rose-700 hover:text-rose-800 bg-rose-50 hover:bg-rose-100 border border-rose-200 rounded-xl flex items-center space-x-1.5 transition-all shadow-2xs active:scale-98 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={isProcessing}
              className="w-full sm:w-auto justify-center px-5 py-2.5 sm:py-2 text-xs font-bold text-slate-950 bg-amber-500 hover:bg-amber-600 active:bg-amber-700 rounded-xl flex items-center space-x-1.5 shadow-sm transition-all active:scale-98 disabled:opacity-50"
            >
